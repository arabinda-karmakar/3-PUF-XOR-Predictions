...
def get_misclassification_rate( X, y, w, b ):
	...
	print(np.average( get_renamed_labels( y ) == predictions ), "Accuracy")
	y_axis.append(np.average( get_renamed_labels( y ) == predictions ))
...
y_new = [y_axis[0], y_axis[5], y_axis[11], y_axis[16], y_axis[21]]

plt.plot(timeouts, y_new)
plt.xlabel('Timeouts')
plt.ylabel('Accuracy')
plt.title('Convergence Curve')
plt.legend(['Convergence curve'], loc='best')
plt.show()